...
def sweep():
    prompt_names = [
        "English GPT-3 style", "Handcrafted GPT-3 style",
        "English MNLI crowdsource", "Handcrafted MNLI crowdsource",
        "English based on the previous passage", "Handcrafted based on the previous passage"
    ]
    sweep_config = {
        "method" : "grid",
