...
do
    ...
    do
        ...
        python -m mega.eval_xnli -p $lang -t $lang --pivot_prompt_name "${prompt_name}" --tgt_prompt_name "${prompt_name}" -k 8 --model "gpt-35-tunro" -e "gpt4v2" --chat-prompt --temperature 0 --log_wandb
    done
done
