...
# do
#     echo "Running for language $lang"
#     python -m mega.eval_qa_gpt4 -p en -t $lang --pivot_prompt_name "answer_given_context_and_question" --tgt_prompt_name "answer_given_context_and_question" -k 4 --model "gptturbo" -e vellm --chat-prompt --temperature 0 --num_evals_per_sec 2 --log_wandb --eval_on_val --chat-prompt -d indicqa
# done
...
# do
#     echo "Running for language $lang"
#     python -m mega.eval_qa_gpt4 -p $lang -t $lang --pivot_prompt_name "answer_given_context_and_question" --tgt_prompt_name "answer_given_context_and_question" -k 4 --model "gptturbo" -e vellm --chat-prompt --temperature 0 --num_evals_per_sec 2 --log_wandb --chat-prompt -d mlqa
# done
