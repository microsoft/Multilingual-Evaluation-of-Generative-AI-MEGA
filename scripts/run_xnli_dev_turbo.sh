...
do
    ...
    do
        ...
        do
            ...
            python -m mega.eval_xnli -p $lang -t $lang --pivot_prompt_name "${prompt_name}" --tgt_prompt_name "${prompt_name}" -k 8 --model "gpt-35-turbo" --chat-prompt --eval_on_val --test_frac 0.2 --temperature $temperature
        done
    done
done