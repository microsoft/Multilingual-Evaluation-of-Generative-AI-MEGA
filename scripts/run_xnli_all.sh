...
do
    ...
    do
        ...
        echo "Running for language $lang and prompt ${prompt_name}"
        python -m mega.eval_xnli -p en -t $lang --pivot_prompt_name "${prompt_name}" --tgt_prompt_name "${prompt_name}" -k 8 --model "gptturbo" -e vellm --chat-prompt --temperature 0 --log_wandb
